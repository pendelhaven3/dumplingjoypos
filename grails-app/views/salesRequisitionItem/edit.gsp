...
<html>
	...
	<body>
		<a href="#edit-salesRequisitionItem" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-salesRequisitionItem" class="content scaffold-edit" role="main">
			...
			<ul class="errors" role="alert">
				<g:eachError bean="${salesRequisitionItemInstance}" var="error">
