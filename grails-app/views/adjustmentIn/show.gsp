    ...
    <body>
        ...
        <div class="body">
            ...
            <div class="buttons">
                <g:form>
                    <g:hiddenField name="id" value="${adjustmentInInstance?.id}" />
                    <span class="button"><g:actionSubmit class="edit" action="postAdjustmentIn" value="Post" /></span>
                </g:form>
            </div>
            ...
            <div class="list" style="padding-top:5px">
                <table>
                    ...
                    <g:each in="${adjustmentInInstance.items}" status="i" var="item">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'} clickable" onclick="window.location='<g:createLink controller='adjustmentInItem' action='edit' id='${item.id}' />'">
                        	...
                        	<td>
                        		<g:link controller="adjustmentInItem" action="delete" id="${item.id}" params="[adjustmentInId:adjustmentInInstance.id]">Delete</g:link>
                        	</td>
