...
<html>
	...
	<body>
		<a href="#edit-adjustmentIn" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-adjustmentIn" class="content scaffold-edit" role="main">
			...
			<ul class="errors" role="alert">
				<g:eachError bean="${adjustmentInInstance}" var="error">
