			...
			<ol class="property-list unitConversion">
				...
				<li class="fieldcontain">
					<span id="fromUnit-label" class="property-label"><g:message code="unitConversion.fromUnit.label" default="From Unit" /></span>
						...
						<span class="property-value" aria-labelledby="fromUnit-label"><g:fieldValue bean="${unitConversionInstance}" field="fromUnit"/></span>
				...
				<li class="fieldcontain">
					<span id="toUnit-label" class="property-label"><g:message code="unitConversion.toUnit.label" default="To Unit" /></span>
						...
						<span class="property-value" aria-labelledby="toUnit-label"><g:fieldValue bean="${unitConversionInstance}" field="toUnit"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${unitConversionInstance?.convertedQuantity}">
				<li class="fieldcontain">
					<span id="convertedQuantity-label" class="property-label"><g:message code="unitConversion.convertedQuantity.label" default="Converted Quantity" /></span>
					
						<span class="property-value" aria-labelledby="convertedQuantity-label"><g:fieldValue bean="${unitConversionInstance}" field="convertedQuantity"/></span>
